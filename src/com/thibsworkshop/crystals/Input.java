...
public class Input {
	...
	public enum KeyState{ SLEEP, DOWN, HOLD, UP}
	...
	public Input(Window window) {
		...
		keys.put(GLFW_KEY_0, KeyState.SLEEP);
		keys.put(GLFW_KEY_1, KeyState.SLEEP);
		keys.put(GLFW_KEY_2, KeyState.SLEEP);
		keys.put(GLFW_KEY_3, KeyState.SLEEP);
		keys.put(GLFW_KEY_4, KeyState.SLEEP);
		keys.put(GLFW_KEY_5, KeyState.SLEEP);
		keys.put(GLFW_KEY_6, KeyState.SLEEP);
		keys.put(GLFW_KEY_7, KeyState.SLEEP);
		keys.put(GLFW_KEY_8, KeyState.SLEEP);
		keys.put(GLFW_KEY_9, KeyState.SLEEP);
